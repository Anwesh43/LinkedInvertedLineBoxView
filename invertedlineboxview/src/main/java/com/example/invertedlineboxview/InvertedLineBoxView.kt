...
fun Canvas.drawInvertedLineBox(scale : Float, w : Float, h : Float, paint : Paint) {
    ...
    val lSize : Float = size / 2
    val upSize : Float = size * sf1
    save()
    translate(w / 2, h / 2)
    rotate(rot * sf4)
...
fun Canvas.drawILBNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawInvertedLineBox(scale, w, h, paint)
}

class InvertedLineBoxView(ctx : Context) : View(ctx) {
    ...
    data class InvertedLineBox(var i : Int) {
    ...
    companion object {
        ...
        fun create(activity : Activity) : InvertedLineBoxView {
            val view : InvertedLineBoxView = InvertedLineBoxView(activity)
